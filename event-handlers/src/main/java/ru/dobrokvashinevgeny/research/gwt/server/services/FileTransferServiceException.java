...
public class FileTransferServiceException extends Exception {
	/**
	 * Создает <code>FileTransferServiceException</code> с указанным
	 ...
	 */
	public FileTransferServiceException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *              что причина несуществует или неизвестна.)
	 */
	public FileTransferServiceException(Throwable cause) {
		super(cause);
	}
}