...
/**
 * Класс ApplicationEventHandler
 */
public class ApplicationEventHandlerException extends Exception {
	/**
	 * Создает <code>ApplicationEventHandlerException</code> с указанным
	 ...
	 */
	public ApplicationEventHandlerException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *              что причина несуществует или неизвестна.)
	 */
	public ApplicationEventHandlerException(Throwable cause) {
		super(cause);
	}
}