...
/**
 * Класс EventPayloadValidation
 */
public class EventPayloadValidationException extends Exception {
	/**
	 * Создает <code>EventPayloadValidationException</code> с указанным
	 * детализирующим сообщением.
	 *
	 * @param message детализирующее сообщение.
	 */
	public EventPayloadValidationException(String message) {
		super(message);
	}
	 ...
	 */
	public EventPayloadValidationException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *              что причина несуществует или неизвестна.)
	 */
	public EventPayloadValidationException(Throwable cause) {
		super(cause);
	}
}